...
namespace csmatio.io
{
	...
	{
	  static readonly string DEFAULT_DESCRIPTIVE_TEXT = "MATLAB 5.0 MAT-file, Platform: " +
													Environment.OSVersion.Platform +
													", CREATED on: ";

	  static readonly int DEFAULT_VERSION = 0x0100;
	  static readonly byte[] DEFAULT_ENDIAN_INDICATOR = {(byte)'I', (byte)'M'};

		readonly int _version;
		readonly string _description;
		readonly byte[] _endianIndicator;
		...
		/// </summary>
		public byte[] EndianIndicator => _endianIndicator;
